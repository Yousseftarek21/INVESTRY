...
const en = {
  ...
  referralLeaderboardPrizeNote: 'The top referrer each month wins a prize. A friend counts once they\u2019ve added a real holding.',
...
const ar: typeof en = {
  ...
  referralLeaderboardPrizeNote: 'الفائز بأعلى عدد إحالات كل شهر يحصل على جائزة. يُحتسب الصديق بعد إضافته أول استثمار فعلي.',

...
const en = {
  ...
  signalsNav: 'INVESTRY Signals',
  signalsNavSub: 'Technical buy/sell ratings for every EGX stock',
...
const ar: typeof en = {
  ...
  signalsNav: 'إنڤستري سيجنالز',
  signalsNavSub: 'توصيات بيع وشراء فنية لكل سهم في البورصة المصرية',

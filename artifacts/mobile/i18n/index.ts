...
const en = {
  ...
  activityCashEditedTitle: (name: string) => `${name} updated` as string,
  activityCashEditedSubtitle: (delta: string, total: string, currency: string) => `${delta} → ${total} ${currency}` as string,
...
const ar: typeof en = {
  ...
  activityCashAddedSubtitle: (name: string, balance: string, currency: string) => `${name} — ${balance} ${currency}` as string,
  activityCashEditedTitle: (name: string) => `تم تحديث ${name}` as string,
  activityCashEditedSubtitle: (delta: string, total: string, currency: string) => `${delta} → ${total} ${currency}` as string,

...
const en = {
  ...
  chartApproximatedHistoryHint: 'Includes purchase-price estimates for assets without daily price history',
...
const ar: typeof en = {
  ...
  chartApproximatedHistoryHint: 'يشمل تقديرات بسعر الشراء للأصول التي لا تتوفر لها بيانات أسعار يومية',

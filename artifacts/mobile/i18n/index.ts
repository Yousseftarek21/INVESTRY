...
const en = {
  ...
  leaderboardNicknamePlaceholder: 'Pick a nickname',
  leaderboardNicknameRequired: 'Enter a nickname to join',
  leaderboardJoinFailed: "Couldn't join right now \u2014 try again",
  leaderboardJoinCta: 'Join the leaderboard',
  leaderboardPrivacyNote: 'Only your name and % return are ever shown \u2014 never your portfolio value. You can leave at any time.',
  leaderboardPending: "You're in \u2014 your rank appears once there's a full day of portfolio history to compare against.",
  leaderboardEditNickname: 'Change your name',
  leaderboardSaveCta: 'Save',
...
const ar: typeof en = {
  ...
  leaderboardNicknamePlaceholder: 'اختر اسمًا مستعارًا',
  leaderboardNicknameRequired: 'أدخل اسمًا مستعارًا للانضمام',
  leaderboardJoinFailed: 'تعذّر الانضمام الآن \u2014 حاول مجددًا',
  leaderboardJoinCta: 'انضم إلى لوحة المتصدرين',
  leaderboardPrivacyNote: 'يظهر فقط اسمك ونسبة العائد \u2014 دون قيمة محفظتك أبدًا. يمكنك الانسحاب في أي وقت.',
  leaderboardPending: 'تم الانضمام \u2014 سيظهر ترتيبك بمجرد توفر يوم كامل من سجل المحفظة للمقارنة.',
  leaderboardEditNickname: 'تغيير الاسم',
  leaderboardSaveCta: 'حفظ',

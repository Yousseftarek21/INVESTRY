...
const en = {
  ...
  overviewGoalSingleSub: (pct: string, saved: string, target: string) => `${pct}% funded · ${saved} / ${target} EGP` as string,
  overviewGoalClusterTitle: (count: string) => `${count} goals` as string,
  overviewGoalClusterSub: (avgPct: string) => `${avgPct}% funded on average` as string,
...
const ar: typeof en = {
  ...
  overviewGoalSingleSub: (pct: string, saved: string, target: string) => `${pct}% ممول · ${saved} / ${target} جنيه` as string,
  overviewGoalClusterTitle: (count: string) => `${count} أهداف` as string,
  overviewGoalClusterSub: (avgPct: string) => `${avgPct}% ممول في المتوسط` as string,

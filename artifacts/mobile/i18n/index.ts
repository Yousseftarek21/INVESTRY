...
const en = {
  ...
  competitionInviteBody: "Compete on your % return, not how much you have. You'll get a random nickname \u2014 no real name or portfolio ever shown.",
  ...
  leaderboardPrivacyNote: 'Only your nickname and % return are ever shown \u2014 never your real name or portfolio value. You can leave at any time.',
...
const ar: typeof en = {
  ...
  competitionInviteBody: 'نافس على نسبة عائدك، لا على المبلغ الذي تملكه. سيُمنح لك اسم مستعار عشوائي \u2014 لا يظهر اسمك الحقيقي أو قيمة محفظتك أبدًا.',
  ...
  leaderboardPrivacyNote: 'يظهر فقط اسمك المستعار ونسبة العائد \u2014 لا اسمك الحقيقي ولا قيمة محفظتك أبدًا. يمكنك الانسحاب في أي وقت.',

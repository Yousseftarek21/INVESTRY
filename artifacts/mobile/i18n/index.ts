...
const en = {
  ...
  addRentalTrackingOption: 'Rental Payment',
  addRentalTrackingOptionDesc: 'Log rent collected on a real estate property',
  back: 'Back',
  ...
  // Rental Tracking — a top-level record type like Dividends above, always
  // tied to a real estate holding the user already saved (see
  // RentalRecord in types/index.ts for why it's not embedded on the
  // holding itself).
  rentalTrackingTitle: 'Rental Tracking',
  addRentalPayment: 'Log Rental Payment',
  editRentalPayment: 'Edit Rental Payment',
  noRentalRecords: 'No rentals logged yet',
  noRentalRecordsHint: 'Log rent you collect from any property or space you rent out',
  rentalPropertyName: 'Property Name',
  rentalPropertyNamePlaceholder: 'e.g. Zamalek Apartment, Marina Chalet, Shop 12',
  rentalPropertyNameRequired: 'Enter a property name.',
  rentalPropertyAreaOptional: 'Property Area (Optional)',
  rentalPropertyAreaPlaceholder: 'Area in m²',
  quickFillFromProperties: 'Quick fill from your properties',
  rentalTenantName: 'Tenant / Guest (Optional)',
  rentalTenantNamePlaceholder: 'e.g. Ahmed Hassan',
  rentalTenantInfoOptional: 'Tenant Info (Optional)',
  rentalTenantInfoPlaceholder: 'Phone, ID number, or any note about the tenant',
  rentalChannel: 'Rental Type',
  channelDirectLease: 'Direct Lease',
  channelAirbnb: 'Airbnb',
  channelBookingCom: 'Booking.com',
  channelOther: 'Other',
  channelOtherPlaceholder: 'Describe the rental type',
  rentalStartDate: 'Start Date',
  rentalEndDateOptional: 'End Date (Optional)',
  rentalEndBeforeStartError: 'End date must be after the start date.',
  rentalNights: (n: number) => `${n} ${n === 1 ? 'night' : 'nights'}` as string,
  perNightSuffix: '/night',
  rentalAmount: 'Amount',
  rentalCurrency: 'Currency',
  rentalPaymentMethod: 'Payment Method',
  paymentMethodCash: 'Cash',
  paymentMethodBankTransfer: 'Bank Transfer',
  paymentMethodInstapay: 'InstaPay',
  paymentMethodVodafoneCash: 'Vodafone Cash',
  rentalNoteOptional: 'Note (Optional)',
  rentalNotePlaceholder: 'Any additional details',
  saveRentalPayment: 'Save Rental Payment',
  deleteRentalPayment: 'Delete Rental Payment',
  deleteRentalPaymentConfirm: 'This will permanently delete this rental record.',
  rentalEntryCount: (n: number) => (n === 1 ? '1 entry' : `${n} entries`) as string,
  subRentalIncomeFull: 'Unlimited rental income tracking',
  holdingCardRented: 'Rented',
  holdingCardRentalHistory: 'Rental history',
  activityRentalAddedTitle: 'New Rental Payment',
  activityRentalAddedSubtitle: (name: string, amount: string, currency: string) => `${name} — ${amount} ${currency}` as string,
  activityRentalEditedTitle: 'Rental Payment Updated',
  activityRentalEditedSubtitle: (name: string, amount: string, currency: string) => `${name} — ${amount} ${currency}` as string,
  ...
  whatsNewSubtitle: 'An update on how INVESTRY works.',
  whatsNewProTitle: 'Free and Pro plans are here',
  whatsNewProBody: "Everything you've already added is completely safe — view and edit it anytime, on any plan. Going forward, adding beyond the free limits (like a 2nd investment), and a few advanced features like the AI Assistant, need Pro.",
  whatsNewCta: 'Got it',
  reloadNow: 'Reload',
  ...
  totalPLBreakdownTitle: 'Where Your Return Comes From',
  totalPLBreakdownEmpty: 'Nothing to break down yet — add a holding to see what makes up your return.',
  ...
  signalsInviteBadge: 'Now Available',
  signalsInviteTitle: 'INVESTRY Signals is live',
  signalsInviteBody: 'Buy/sell ratings, real indicators, and stop-loss/take-profit levels for every EGX stock — try it free on the web.',
  signalsInviteCta: 'Open Signals',
  ...
  leaderboardResultsEyebrowWeek: "Last Week's Results",
  leaderboardResultsEyebrowMonth: "Last Month's Results",
  leaderboardResultsBody: "Here's how the Performance Leaderboard wrapped up.",
  leaderboardResultsDismiss: 'Got it',
  leaderboardResultsCardTitleWeek: "Last Week's Top 3",
  leaderboardResultsCardTitleMonth: "Last Month's Top 3",
  ...
  referralMonthsEarned: 'Pro months earned',
...
const ar: typeof en = {
  ...
  addRentalTrackingOption: 'دفعة إيجار',
  addRentalTrackingOptionDesc: 'سجّل إيجارًا حصلت عليه من عقار',
  back: 'رجوع',
  ...
  rentalTrackingTitle: 'تتبع الإيجار',
  addRentalPayment: 'تسجيل دفعة إيجار',
  editRentalPayment: 'تعديل دفعة إيجار',
  noRentalRecords: 'لا توجد إيجارات مسجلة بعد',
  noRentalRecordsHint: 'سجل أي إيجار تحصل عليه من أي عقار أو مساحة تؤجرها',
  rentalPropertyName: 'اسم العقار',
  rentalPropertyNamePlaceholder: 'مثال: شقة الزمالك، شاليه مارينا، محل 12',
  rentalPropertyNameRequired: 'أدخل اسم العقار.',
  rentalPropertyAreaOptional: 'مساحة العقار (اختياري)',
  rentalPropertyAreaPlaceholder: 'المساحة بالمتر المربع',
  quickFillFromProperties: 'تعبئة سريعة من عقاراتك',
  rentalTenantName: 'المستأجر / الضيف (اختياري)',
  rentalTenantNamePlaceholder: 'مثال: أحمد حسن',
  rentalTenantInfoOptional: 'معلومات المستأجر (اختياري)',
  rentalTenantInfoPlaceholder: 'رقم الهاتف أو الرقم القومي أو أي ملاحظة عن المستأجر',
  rentalChannel: 'نوع الإيجار',
  channelDirectLease: 'إيجار مباشر',
  channelAirbnb: 'Airbnb',
  channelBookingCom: 'Booking.com',
  channelOther: 'أخرى',
  channelOtherPlaceholder: 'صف نوع الإيجار',
  rentalStartDate: 'تاريخ البدء',
  rentalEndDateOptional: 'تاريخ الانتهاء (اختياري)',
  rentalEndBeforeStartError: 'يجب أن يكون تاريخ الانتهاء بعد تاريخ البدء.',
  rentalNights: (n: number) => `${n} ${n === 1 ? 'ليلة' : 'ليالٍ'}` as string,
  perNightSuffix: '/ليلة',
  rentalAmount: 'المبلغ',
  rentalCurrency: 'العملة',
  rentalPaymentMethod: 'طريقة الدفع',
  paymentMethodCash: 'نقدًا',
  paymentMethodBankTransfer: 'تحويل بنكي',
  paymentMethodInstapay: 'إنستاباي',
  paymentMethodVodafoneCash: 'فودافون كاش',
  rentalNoteOptional: 'ملاحظة (اختياري)',
  rentalNotePlaceholder: 'أي تفاصيل إضافية',
  saveRentalPayment: 'حفظ دفعة الإيجار',
  deleteRentalPayment: 'حذف دفعة الإيجار',
  deleteRentalPaymentConfirm: 'سيتم حذف سجل هذا الإيجار نهائيًا.',
  rentalEntryCount: (n: number) => (n === 1 ? 'إدخال واحد' : `${n} إدخالات`) as string,
  subRentalIncomeFull: 'تتبّع دخل إيجار غير محدود',
  holdingCardRented: 'مؤجر',
  holdingCardRentalHistory: 'سجل إيجار',
  activityRentalAddedTitle: 'دفعة إيجار جديدة',
  activityRentalAddedSubtitle: (name: string, amount: string, currency: string) => `${name} — ${amount} ${currency}` as string,
  activityRentalEditedTitle: 'تم تحديث دفعة الإيجار',
  activityRentalEditedSubtitle: (name: string, amount: string, currency: string) => `${name} — ${amount} ${currency}` as string,
  ...
  whatsNewSubtitle: 'تحديث عن طريقة عمل INVESTRY.',
  whatsNewProTitle: 'خطط مجانية و Pro أصبحت متاحة',
  whatsNewProBody: 'كل ما أضفته بالفعل آمن تمامًا — شوفه وعدّله في أي وقت، على أي خطة. من الآن، إضافة أكتر من الحد المجاني (زي استثمار ثاني)، وبعض المزايا المتقدمة زي المساعد الذكي، تحتاج Pro.',
  whatsNewCta: 'حسناً',
  ...
  totalPLBreakdownTitle: 'من أين يأتي عائدك',
  totalPLBreakdownEmpty: 'لا يوجد شيء لتحليله بعد — أضف استثمارًا لترى مما يتكون عائدك.',
  ...
  signalsInviteBadge: 'متاح الآن',
  signalsInviteTitle: 'إنڤستري سيجنالز بقى شغال',
  signalsInviteBody: 'توصيات بيع وشراء، مؤشرات حقيقية، ووقف خسارة/جني أرباح لكل سهم في البورصة المصرية — جربه مجانًا على الإنترنت.',
  signalsInviteCta: 'افتح Signals',
  ...
  leaderboardResultsEyebrowWeek: 'نتائج الأسبوع الماضي',
  leaderboardResultsEyebrowMonth: 'نتائج الشهر الماضي',
  leaderboardResultsBody: 'شوف إزاي انتهت لوحة الأداء.',
  leaderboardResultsDismiss: 'تمام',
  leaderboardResultsCardTitleWeek: 'أفضل 3 الأسبوع الماضي',
  leaderboardResultsCardTitleMonth: 'أفضل 3 الشهر الماضي',
  ...
  referralMonthsEarned: 'أشهر Pro المكتسبة',

  ...
  return (
    <View style={rb.wrap}>
      ...
      <View style={[rb.track, { backgroundColor: colors.border }]}>
        ...
        <View style={[rb.thumb, { start: `${Math.round(pct * 100)}%`, backgroundColor: colors.primary }]} />
      </View>
      <Text style={[rb.label, { color: colors.mutedForeground }]}>
        {high.toFixed(0)}
      </Text>
...
const rb = StyleSheet.create({
  ...
  fill: { position: 'absolute', start: 0, top: 0, height: 4, borderRadius: 2 },
  thumb: { position: 'absolute', top: -3, width: 10, height: 10, borderRadius: 5, marginStart: -5 },
});

...
export type ActivityType = 'cash_added' | 'cash_edited' | 'holding_added' | 'holding_edited' | 'holding_sold' | 'income_added' | 'income_edited' | 'income_collected' | 'rental_added' | 'rental_edited';
